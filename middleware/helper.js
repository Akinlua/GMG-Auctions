...
const pagination = async (result, count, req, res ) => {
    ...
    return {modelinstances: modelinstances, noOfPages: noOfPages, hasNextPage: hasNextPage, 
        hasPrevPage: hasPrevPage, nextPage: nextPage, prevPage: prevPage,page: page, count: count, startPoint: startPoint, endPoint: endPoint}
    // END PAGINATION
}
